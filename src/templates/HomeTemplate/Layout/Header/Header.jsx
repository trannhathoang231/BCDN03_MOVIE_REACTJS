    ...
    <header className="p-1 bg-coolGray-100 text-coolGray-100 fixed w-full" style={{zIndex:'10',backgroundColor:'rgba(255,255,255,.95)'}} >
      <div className="container flex justify-between h-16 mx-auto m-auto">
        ...
        <div className="items-center flex-shrink-0 hidden lg:flex">
          <NavLink to={`/checkout/:id`}  className="self-center px-2 py-3 rounded text-black">Sign in</NavLink>
          <NavLink to={`/register`} className="self-center px-2 py-3 font-semibold rounded dark:bg-violet-400 dark:text-gray-900 text-black">Sign up</NavLink>
        </div>
